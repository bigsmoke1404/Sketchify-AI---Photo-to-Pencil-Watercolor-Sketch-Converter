...
st.set_page_config(
    ...
    menu_items={
        ...
        "About": "Sketchify AI — Transform your photos into stunning Pencil Sketches & Watercolor Art.",
    },
)
...
<div class="hero-wrap">
  ...
  <p class="hero-sub">
    ...
    using AI-inspired image processing — instantly, in your browser.
  </p>
  <div>
    ...
    with col_set:
        ...
        if is_pencil:
            ...
            intensity_pct = st.slider(
                ...
                format="%d%%",
                help="Higher = softer, more diffuse pencil strokes",
            )
            edge_pct = st.slider(
                "Edge Thickness",
                min_value=10, max_value=100, value=50, step=5,
                format="%d%%",
                help="Higher = sharper, bolder line edges",
            )
...
produce an enhanced or artistically modified output. Sketchify AI uses Python's Pillow library 
to simulate the look of hand-drawn artwork.</p>
</div>

<div class="about-card">
<h4>✏️ How Pencil Sketch Works</h4>
<p>The pencil sketch uses a dodge-blend technique:</p>
<ol>
  <li>Convert to grayscale</li>
  <li>Invert colors</li>
  <li>Apply Gaussian blur</li>
  <li>Blend the inverted blur with the grayscale image</li>
</ol>
</div>
""",
            unsafe_allow_html=True,
...
<p>The watercolor effect chains multiple Pillow operations:</p>
<ol>
  <li>Apply multiple passes of median filtering to smooth colors while preserving edges</li>
  <li>Boost saturation heavily for vibrancy</li>
  <li>Smooth slightly more to reduce artifacts</li>
...
<div class="custom-footer">
  <p>🎨 <strong>Sketchify AI</strong> — Built with Streamlit · Pillow</p>
  <p>
